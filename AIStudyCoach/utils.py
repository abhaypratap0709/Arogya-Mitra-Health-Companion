...
def init_session_state():
    ...
    # QR payload cache once user is logged in
    if 'user_id' in st.session_state and 'qr_payload' not in st.session_state:
        st.session_state.qr_payload = f"AMITRA:{st.session_state.user_id}"
